...
class MediaDiscoveryController extends GetxController with StateMixin<List<Media>> {
  final MediaRepository _repository;
  final AuthController authController = Get.find<AuthController>();

  MediaDiscoveryController(this._repository);
  ...
  final RxList<Media> trendingMedia = <Media>[].obs;
  final RxList<Media> popularMedia = <Media>[].obs;
  final RxList<Media> nowPlayingMedia = <Media>[].obs;
  ...
  Future<void> fetchFilteredMedia() async {
    ...
    try {
      ...
      trendingMedia.assignAll(results);
      popularMedia.clear();
  ...
  Future<void> fetchAllMedia() async {
    try {
      ...
      trendingMedia.assignAll(results[0]);
      popularMedia.assignAll(results[1]);
      nowPlayingMedia.assignAll(results[2]);
